...
def DDA(x1, y1, x2, y2):
    ...
    for i in range (0, int (steps+1)) :
        ...
        plt.gca().add_patch(Rectangle((x3, y3), 1, 1, linewidth=1, edgecolor='blue', facecolor='yellow'))
        plt.gca().add_patch(Rectangle((x1r, y1r), 1, 1, linewidth=1, edgecolor='blue', facecolor='yellow'))
        plt.gca().add_patch(Rectangle((x2r, y2r), 1, 1, linewidth=1, edgecolor='blue', facecolor='yellow'))
...
def Bresenham(x1, y1, x2, y2):
    ...
    while (x<=x2) or (yr<=y3):
        plt.gca().add_patch(Rectangle((x, y), 1, 1, linewidth=1, edgecolor='green', facecolor='red'))
        plt.gca().add_patch(Rectangle((x3, y3), 1, 1, linewidth=1, edgecolor='green', facecolor='red'))
        plt.gca().add_patch(Rectangle((xr, yr), 1, 1, linewidth=1, edgecolor='green', facecolor='red'))
        plt.gca().add_patch(Rectangle((x2, y2), 1, 1, linewidth=1, edgecolor='green', facecolor='red'))
        x+=1; x3+=1
        yr+=1; y2+=1
        if (p<0):
            p=p+2*dy
